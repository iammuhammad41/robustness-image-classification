...
# parser.add_argument('-b', '--batch-size', default=64, type=int, metavar='N', help='mini-batch size (default: 128) used for test')
parser.add_argument('-b', '--batch-size', default=64, type=int, metavar='N',
                    help='mini-batch size (default: 128), used for train and validation')
parser.add_argument('--print-freq', '-p', default=10, type=int, metavar='N', help='print frequency (default: 10)')
# parser.add_argument('--model-dir', default='./Results/resnet35_lr_0.05/model_best.pth.tar',
...
def main():
    ...
    dataframe = pd.DataFrame({'Id': imgs, 'Prediction': preds})
